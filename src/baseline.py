...
from src.eval_prompts import CORE_EVAL_ITEMS, ROBUSTNESS_EVAL_ITEMS, EvalResultItem
...
def evaluate_baseline(model: Any, tokenizer: Any) -> list[EvalResultItem]:
    results: list[EvalResultItem] = []
    pad_token_id = tokenizer.eos_token_id
    for item in CORE_EVAL_ITEMS + ROBUSTNESS_EVAL_ITEMS:
        prompt = item["prompt"]
        ...
        results.append({**item, "output": output_text})
