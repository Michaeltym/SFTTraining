...
- Current Best LoRA Result: [dataset_3-Qwen-Qwen2.5-0.5B-8-0.0001-2026-04-12-202539.json](/Users/michaeltan/Desktop/training/sft-training/experiments/eval_results/post_sft/dataset_3-Qwen-Qwen2.5-0.5B-8-0.0001-2026-04-12-202539.json)
...
- Treat `lr = 1e-4`, `r = 16`, `alpha = 32` as the current best local LoRA setting
- If more local tuning is attempted, compare against this run instead of the weaker `2e-5` LoRA runs
